<template>
  <div class="glass-card h-100 p-3 d-flex flex-column">
    ...
    <!-- Custom Legend -->
    <div
      class="d-flex justify-content-center flex-wrap mt-1 text-muted"
    ...
    computedChartData() {
      ...
      this.tbsDetailData.forEach((item) => {
        ...
        planData.push({
          ...
          tooltext: `<b>${
            item.company_code
          } Target</b>: ${new Intl.NumberFormat('en-US', {
            maximumFractionDigits: 2,
          }).format(item.plan)} TON`,
        })
        ...
        actualData.push({
          ...
          tooltext: `<b>${
            item.company_code
          } Aktual</b>: ${new Intl.NumberFormat('en-US', {
            maximumFractionDigits: 2,
          }).format(item.actual)} TON<br>Persentase: ${item.percentage}%`,
        })
      })
