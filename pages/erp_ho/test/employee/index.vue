        ...
        <div class="card-body">
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link
                  :to="{ name: 'erp_ho-test-employee-create' }"
          ...
          >
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_ho-test-employee-edit-id',
...
export default {
  ...
  async asyncData({ $axios, query }) {
    ...
    const posts = await $axios.$get(
      `/api/admin/sql_employee?q=${search}&page=${page}`
    )
  ...
  methods: {
    ...
    exportData() {
      ...
      this.$axios({
        url: `/api/admin/sql_employee/export`,
        method: 'GET',
        responseType: 'blob',
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            this.$axios
              .delete(`/api/admin/sql_employee/${id}`)
              .then((response) => {
                //feresh data
                this.$nuxt.refresh()
