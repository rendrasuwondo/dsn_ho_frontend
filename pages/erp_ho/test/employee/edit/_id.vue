    ...
    <section class="content">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-id-badge"></i> <b>EDIT KARYAWAN</b>
          </h3>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/sql_employee/${this.$route.params.id}`)
      .then((response) => {
        console.log('rdr')
  ...
  methods: {
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/sql_employee/${this.$route.params.id}`, {
          //data yang dikirim
