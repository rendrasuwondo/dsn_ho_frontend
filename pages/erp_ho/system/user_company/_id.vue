          ...
          <div class="card-body">
            ...
            <div class="form-group">
              <div class="input-group mb-3">
                <div class="input-group-prepend">
                  <nuxt-link
                    :to="{
                      name: 'erp_ho-system-user_company-create-id',
            ...
            >
              ...
              <template v-slot:cell(actions)="row">
                <b-button
                  :to="{
                    name: 'erp_ho-system-user_company-edit-id',
              ...
              <template v-slot:cell(detail)="row">
                <b-button
                  :to="{
                    name: 'erp_ho-system-user_company',
  ...
  export default {
    ...
    async asyncData({ $axios, query, route }) {
      ...
      const posts = await $axios.$get(
        `/api/admin/detail/user_company/${id}?q=${search}&page=${page}`
      )
    ...
    methods: {
        ...
        this.$swal
          ...
          .then((result) => {
            if (result.isConfirmed) {
              ...
              this.$axios
                .delete(`/api/admin/user_company/${id}`)
                .then((response) => {
                  //feresh data
                  this.$nuxt.refresh()
      ...
      this.$axios({
        url: `/api/admin/user_company/export?q=${this.search}&users_id=${this.users_id}`,
        method: 'GET',
        responseType: 'blob',
        ...
        link.href = url
        var fileName = 'User - company.xlsx'
