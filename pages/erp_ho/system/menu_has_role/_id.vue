        ...
        <div class="card-body">
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_ho-system-menu_has_role-edit-id',
            ...
            <template v-slot:cell(detail)="row">
              <b-button
                :to="{
                  name: 'erp_ho-system-menu_has_role',
...
export default {
  ...
  methods: {
    ...
    exportData() {
      ...
      this.$axios({
        url: `/api/admin/sql_menu_has_role/export?menu_id=${this.menu_id}`,
        method: 'GET',
        responseType: 'blob',
