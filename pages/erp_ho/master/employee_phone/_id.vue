        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <nuxt-link
                  :to="{
                    name: 'erp_ho-master-employee_phone-create-id',
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_ho-master-employee_phone-edit-id',
...
export default {
  ...
  async asyncData({ $axios, query, route }) {
    ...
    const posts = await $axios.$get(
      `/api/admin/detail/employee_phone/${id}?q=${search}&page=${page}`
    )
  ...
  methods: {
      ...
      this.$swal
        ...
        .then((result) => {
          if (result.isConfirmed) {
            ...
            this.$axios
              .delete(`/api/admin/employee_phone/${id}`)
              .then((response) => {
                //feresh data
                this.$nuxt.refresh()
    ...
    exportData() {
      ...
      this.$axios({
        url: `/api/admin/employee_phone/export?q=${this.search}&employee_id=${this.employee_id}`,
        method: 'GET',
        responseType: 'blob',
        ...
        link.href = url
        var fileName = 'Employee - Phone Number.xlsx'
