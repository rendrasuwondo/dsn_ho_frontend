          ...
          <h3 class="card-title">
            <table>
              <tr>
                <td>
                  <nuxt-link
                    :to="{ name: 'erp_ho-fertilizer-vendors' }"
                    class="nav-link"
                  >
                    <i class="nav-icon fas fas fa-dolly-flatbed"></i>
                    <b>VENDORS</b>
                  </nuxt-link>
                </td>
                <td>/ LABORATORY</td>
        ...
        <div class="card-body">
          ...
          >
            ...
            <template v-slot:cell(actions)="row">
              <b-button
                :to="{
                  name: 'erp_ho-fertilizer-vendors_laboratory-edit-id',
...
export default {
  ...
  data() {
    return {
      ...
      vendors_id: this.$route.params.id,
  ...
  async asyncData({ $axios, query, route }) {
    ...
    //role
    const role = await $axios.get(`/api/admin/master/vendors/${id}`)
