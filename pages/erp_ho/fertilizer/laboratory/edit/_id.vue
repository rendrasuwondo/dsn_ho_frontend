    ...
    <section class="content" v-if="show === 1">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-vial"></i> <b>EDIT LABORATORY</b>
          </h3>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/laboratory/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
  ...
  methods: {
    back() {
      this.$router.push({
        name: 'erp_ho-fertilizer-laboratory',
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/laboratory/${this.$route.params.id}`, {
          //data yang dikirim
