    ...
    <section class="content" v-if="show === 1">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-swatchbook"></i> <b>EDIT JENIS DOKUMEN</b>
          </h3>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/document_type/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
        ...
        this.field.PARENT_ID = response.data.data.parent
  ...
  methods: {
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/document_type/${this.$route.params.id}`, {
          //data yang dikirim
          ...
          TDOC: this.field.TDOC,
          PARENT_ID: this.field.PARENT_ID.P_WF_DOC_TYPE_ID
