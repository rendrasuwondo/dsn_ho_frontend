    ...
    <section class="content" v-if="show === 1">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-network-wired"></i> <b>EDIT INIT</b>
          </h3>
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/init_workflow/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
        this.field.P_WF_DOC_TYPE_ID = response.data.data.document_type
        this.field.P_WF_PROC_ID_INIT = response.data.data.process
        this.field.WF_GROUP = response.data.data.WF_GROUP
  ...
  methods: {
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/init_workflow/${this.$route.params.id}`, {
          //data yang dikirim
          WF_GROUP: this.field.WF_GROUP,
          ...
          P_WF_DOC_TYPE_ID: this.field.P_WF_DOC_TYPE_ID.P_WF_DOC_TYPE_ID
            ...
            : '',
          P_WF_PROC_ID_INIT: this.field.P_WF_PROC_ID_INIT.P_WF_PROC_ID
