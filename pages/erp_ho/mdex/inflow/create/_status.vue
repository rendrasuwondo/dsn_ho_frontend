    ...
    <section class="content" v-if="show === 1">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-industry"></i> TAMBAH INFLOW
          </h3>
        ...
        <div class="card-body">
          <form @submit.prevent="storePost">
            ...
            <div class="form-group">
              ...
              <input
                type="text"
                v-model="field.account_status"
                placeholder="Masukkan Account Status"
                class="form-control"
                ref="account_status"
                readonly
              />
...
export default {
  ...
  mounted() {
    ...
    //Data Account Status
    this.field.account_status = this.$route.params.status
    //Data Product
    this.$axios
  ...
  methods: {
    ...
    async storePost() {
      ...
      formData.append('product_id',this.field.product_id ? this.field.product_id.id : '')
      formData.append('inflow_date', this.field.inflow_date)
      formData.append('account_status', this.field.account_status)
      formData.append('inflow', this.field.inflow)
      ...
      await this.$axios
        .post('/api/admin/inflow', formData)
        .then(() => {
          this.show = 1
