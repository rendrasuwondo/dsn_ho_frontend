    ...
    <section class="content" v-if="show === 1">
      <div class="card card-outline card-info">
        <div class="card-header">
          <h3 class="card-title">
            <i class="nav-icon fas fa-industry"></i> EDIT PIC
          </h3>
        ...
        <div class="card-body">
          <form @submit.prevent="update">
            ...
            <div class="form-group">
              ...
              <div v-if="validation.is_active" class="mt-2">
                <b-alert show variant="danger">{{
...
export default {
  ...
  mounted() {
    ...
    this.$axios
      .get(`/api/admin/pic/${this.$route.params.id}`)
      .then((response) => {
        //data yang diambil
  ...
  methods: {
    ...
    async update(e) {
      ...
      await this.$axios
        .put(`/api/admin/pic/${this.$route.params.id}`, {
          //data yang dikirim
          // nik: this.field.nik,
